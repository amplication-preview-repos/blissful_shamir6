...
const CREATE_INPUT = {
  ...
  haveWorkedWithClient: "exampleHaveWorkedWithClient",
  haveWorkedWithMls: "true",
  id: "exampleId",
  lastname: "exampleLastname",
  mileage: "true",
  nativeLanguages: "exampleNativeLanguages",
  notes: "exampleNotes",
  phone: "examplePhone",
  rateOtherComments: "exampleRateOtherComments",
  ratePerHour: 42.42,
  ratePerWordBySource: 42.42,
  ratePerWordByTarget: 42.42,
  sourceLanguages: "exampleSourceLanguages",
  targetLanguages: "exampleTargetLanguages",
  tmFields: "exampleTmFields",
  updatedAt: new Date(),
